...
Vue.component('todo-input', __webpack_require__(45));
Vue.component('todo-item', __webpack_require__(48));
...
var update = __webpack_require__(41)("37cad660", content, false);
    ...
    methods: {
        ...
        addTodo: function addTodo() {
            ...
            axios.post('api/todos', {
                ...
                _this2.todoItemText = '', _this2.errors = [];
                _this2.getTodo();
            }).catch(function (error) {
                _this2.errors = 'Ocurrió un error al guardar';
            });
        },
        ...
        toggleDone: function toggleDone(todo) {
            ...
            axios.put('api/todos/' + todo.id, { done: todo.done }).then(function (response) {
                ...
                _this4.errors = 'Corrija para poder editar con éxito';
            });
        }
    }
});
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-03b07886", Component.options)
  } else {
    hotAPI.reload("data-v-03b07886", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
    ...
    _c("div", { staticClass: "field is-grouped" }, [
      _c("p", { staticClass: "control is-expanded" }, [
        _c("input", {
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.$parent.todoItemText,
              expression: "$parent.todoItemText"
            }
          ],
          staticClass: "input",
          attrs: {
          ...
          domProps: { value: _vm.$parent.todoItemText },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.$set(_vm.$parent, "todoItemText", $event.target.value)
            }
          }
        })
      ]),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-03b07886", module.exports)
  }
}
